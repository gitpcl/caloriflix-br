<div 
    class="container max-w-4xl mx-auto px-4 py-8"
    x-data="{
                ...
                <div>
                    ...
                    <div class="relative">
                        <select 
                            ...
                            class="bg-white border border-gray-300 text-gray-700 py-2 px-4 pr-8 rounded-lg w-full appearance-none focus:outline-none focus:ring-2 focus:ring-blue-500"
                        >
