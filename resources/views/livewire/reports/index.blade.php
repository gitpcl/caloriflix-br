                    ...
                    <div class="p-6">
                        ...
                        <div class="flex gap-3 mt-6">
                            ...
                            <button
                                ...
                                type="button"
                                class="flex-1 inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg text-white bg-caloriflix-300 hover:bg-caloriflix-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-caloriflix-500"
                            >
                                Adicionar
                            </button>
                        </div>
        ...
        @else
            ...
            <div class="mt-4 rounded-lg bg-gray-50 p-6 dark:bg-gray-800">
                <div class="text-center">
                    ...
                    <div class="mt-6">
                        <a href="{{ route('meals.index') }}" class="inline-flex items-center rounded-md bg-caloriflix-300 px-3 py-2 text-sm font-semibold text-black shadow-sm hover:bg-caloriflix-400 focus:outline-2 focus:outline-offset-2 focus:outline-caloriflix-600">
                ...
                <div class="text-center">
                    ...
                    <div class="mt-6">
                        <button
                            ...
                            class="inline-flex items-center rounded-md bg-caloriflix-300 px-3 py-2 text-sm font-semibold text-black shadow-sm hover:bg-caloriflix-400 focus:outline-2 focus:outline-offset-2 focus:outline-caloriflix-600"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="-ml-0.5 mr-1.5 h-5 w-5 lucide lucide-plus">
                                <line x1="12" x2="12" y1="5" y2="19"/>
<line x1="5" x2="19" y1="12" y2="12"/>
